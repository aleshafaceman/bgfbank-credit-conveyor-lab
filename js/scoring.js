...
var scoringSteps = [
    ...
    { name: 'Оценка недвижимости', source: 'Мобильный оценщик', time: '2.8 сек', detail: 'Рыночная стоимость: 8 500 000 ₽. Ликвидность: высокая. Кредит к стоимости: 60%.' },
    { name: 'Андеррайтинг', source: 'Система скоринга банка', time: '3.2 сек', detail: 'Платёж к доходу: 38% (норма). Долговая нагрузка: 42% (норма). Стоп-факторы отсутствуют.' },
