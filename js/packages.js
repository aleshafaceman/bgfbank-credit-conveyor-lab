...
const PACKAGE_CATALOG = {
    PKG_RECOMMENDED: {
        title: 'Турбо 2.0',
        description: 'Предварительное предложение подготовлено по данным Госуслуг: доход подтверждён цифровым профилем, справка 2-НДФЛ не нужна. В вариант входят комплексное страхование заёмщика (ККС) и стандартные комиссии банка.',
