    ...
    document.getElementById('m-tab-reports').innerHTML = `
        <div class="m-reports-wrap">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:16px;margin-top:24px;">
                ...
                <div class="m-app-detail" style="text-align:center;"><div style="font-size:28px;font-weight:800;color:#13A538;">${pct(approved)}%</div><div style="font-size:13px;color:#7e9bb6;">Доля одобрений</div></div>
                <div class="m-app-detail" style="text-align:center;"><div style="font-size:28px;font-weight:800;color:#0B4697;">~2.5 дня</div><div style="font-size:13px;color:#7e9bb6;">Среднее время</div></div>
            </div>
        </div>
    `;
}
