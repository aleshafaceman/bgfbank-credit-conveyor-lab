...
function loadSharedData() {
    ...
    try {
        ...
        if (savedMessages) {
            ...
            sharedMessages = [
                { id: 'msg1', from: 'manager', to: 'Александр Кузнецов', text: 'Александр, добрый день! Меня зовут Марина, я ваш кредитный менеджер. Нужна помощь с заявкой №4421-И?', time: '14:15', date: '15.06.2026', read: true },
